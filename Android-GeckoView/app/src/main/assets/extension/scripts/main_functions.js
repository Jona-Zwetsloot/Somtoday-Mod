...
function onload() {
    ...
    function style() {
        ...
        if (get('layout') == 2 || get('layout') == 3 || get('layout') == 5) {
            ...
            tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">@media (max-width: 766px){sl-header:not(.with-back-button){border-bottom:none !important;--column-width: 100% !important;}sl-dagen-header{top:calc(' + (get('layout') == 5 ? '0px' : '64px') + ' + var(--safe-area-inset-top)) !important;border-bottom:none !important;}sl-berichten{background-color:var(--bg-neutral-none);}}</style>');
