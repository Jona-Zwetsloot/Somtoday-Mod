...
function execute(functionarray) {
    for (const element of functionarray) {
        try {
            ...
            if (get('bools') == null || (window.location.origin.indexOf("leerling") != -1 && get('bools').charAt(4) == '1')) {
...
function onload() {
    ...
    let menuColor;
    let highLightColor;
    let isCollectingRecapData = false;
    ...
    function easterEggs() {
        ...
        function easterEggShake() {
            ...
            for (const element of tn('sl-geen-data')) {
                element.addEventListener('mouseover', function () { shakeOnHover(this, -30, 30, -30, 30); });
            }
    ...
    function customHomework() {
        if (get('bools').charAt(16) == '1' && !homeworkBusy) {
    ...
    function ariaLabelToDate(element) {
        ...
        if (element.getElementsByClassName('header')[0]) {
            ...
            dateString = (n(element.children[0].ariaLabel) ? '' : element.children[0].ariaLabel.match(/ (\d*? [a-z]*?)${"$"}/, '')[1]) + ' ';
        }
        else {
            ...
            function addHomework(j) {
                ...
                if ((showIfOnce || showIfWeekly || showIfMonthly) && n(element.getElementsByClassName('mod-homework-' + homework[i].id)[0]) && ((isWeek && homework[i].week) || (!isWeek && !homework[i].week))) {
                    ...
                    if (done) {
                        ...
                        insertElement = element.getElementsByClassName('header')[0] ? element.getElementsByClassName('header')[0] : element.getElementsByClassName('dag-header')[0];
                    }
                    if (!n(insertElement)) {
                        ...
                        homeworkItem.getElementsByTagName('div')[0].addEventListener('click', function (e) {
                            ...
                            if (homeworkItem.classList.contains('mod-huiswerk-done')) {
                                ...
                                if (n(element.getElementsByTagName('sl-studiewijzer-items')[0])) {
            ...
            if (!n(tn('sl-laatsteresultaten', 0)) && !n(tn('sl-resultaat-item', 0))) {
                ...
                for (const element of cn('cijfer')) {
                    ...
                    if (!n(element.children[0])) {
                        if (get('bools').charAt(14) == '1' && (element.children[0].innerHTML == lastGrade && (n(element.parentElement.parentElement.parentElement.getElementsByClassName('titel')[0]) || element.parentElement.parentElement.parentElement.getElementsByClassName('titel')[0].innerHTML == lastGradeTitle) && (n(element.parentElement.parentElement.parentElement.getElementsByClassName('subtitel')[0]) || element.parentElement.parentElement.parentElement.getElementsByClassName('subtitel')[0].innerHTML.split('• ')[1] == lastGradeDescription))) {
                            break;
                        }
                        else if (i == 0) {
    ...
    function rosterSimplify() {
       ...
       function style() {
        ...
        tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">.circles{ position: absolute; top: 0; left: 0; width: 100%; height: 100%; overflow: hidden; pointer-events: none; } .circles li{ position: absolute; display: block; list-style: none; width: 20px; height: 20px; background: rgba(255, 255, 255, 0.2); animation: animate 25s linear infinite; bottom: -150px; } .circles li:nth-child(1){ left: 25%; width: 80px; height: 80px; animation-delay: 0s; } .circles li:nth-child(2){ left: 10%; width: 20px; height: 20px; animation-delay: 2s; animation-duration: 12s; } .circles li:nth-child(3){ left: 70%; width: 20px; height: 20px; animation-delay: 4s; } .circles li:nth-child(4){ left: 40%; width: 60px; height: 60px; animation-delay: 0s; animation-duration: 18s; } .circles li:nth-child(5){ left: 65%; width: 20px; height: 20px; animation-delay: 0s; } .circles li:nth-child(6){ left: 75%; width: 110px; height: 110px; animation-delay: 3s; } .circles li:nth-child(7){ left: 35%; width: 150px; height: 150px; animation-delay: 7s; } .circles li:nth-child(8){ left: 50%; width: 25px; height: 25px; animation-delay: 15s; animation-duration: 45s; } .circles li:nth-child(9){ left: 20%; width: 15px; height: 15px; animation-delay: 2s; animation-duration: 35s; } .circles li:nth-child(10){ left: 85%; width: 150px; height: 150px; animation-delay: 0s; animation-duration: 11s; } @keyframes animate { 0%{ transform: translateY(0) rotate(0deg); opacity: 1; border-radius: 0; } 100%{ transform: translateY(-1000px) rotate(720deg); opacity: 0; border-radius: 50%; } }</style>');
            ...
            tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">hmy-switch-group:has(hmy-switch),sl-bericht-detail .header,sl-bericht-nieuw > .titel{border-radius:6px;padding:10px;background-color:var(--bg-neutral-none);}.content:has(sl-registraties){background:var(--mod-transparent);}sl-studiewijzer-week{border-bottom:2px solid var(--mod-transparent) !important;}sl-studiewijzer-dag{border-right:2px solid var(--mod-transparent) !important;}' + (get('bools').charAt(15) == '1' ? 'sl-rooster-week .uur{border-left:2px solid var(--mod-transparent) !important;border-bottom:2px solid var(--mod-transparent) !important;}' : '') + '.container:has(sl-vakresultaten){padding-bottom:0 !important;}sl-vakresultaten{background-color:var(--bg-neutral-none);padding:20px !important; padding-bottom:40px !important;}sl-geen-data > span{margin-top:20px;}sl-geen-data{background:var(--mod-ui-transparent);padding:30px 60px;border-radius:24px;}</style>');
        }
            ...
            tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">.container{max-width:100%;}sl-header sl-tab-bar div.item span,sl-tab-bar sl-tab-item .item span{text-overflow:ellipsis;overflow:hidden;text-wrap:nowrap;margin-left:-5px;width:calc(100% + 10px);}sl-tab-bar sl-tab-item .item span{' + (get('layout') == 3 ? 'margin-left:5px;' : '') + 'width:calc(100% - 10px);text-align:center;}#mod-menu-resizer{width:12px;height:100%;' + (get('layout') == 3 ? 'left' : 'right') + ':-4px;position:absolute;cursor:ew-resize;}sl-tab-bar sl-tab-item .item{padding-bottom:0 !important;}sl-rooster-dag.dag{width:calc(100vw - 170px) !important;}hmy-notification-counter span{margin:0 !important;}sl-header hmy-notification-counter{position:absolute;right:30px;top:20px;}sl-tab-bar:first-of-type sl-tab-item{position:relative;}.active-border-top,.active-border-bottom{top:0;height:100% !important;width:4px !important;position:absolute;' + (get('layout') != 3 ? 'right' : 'left') + ':0;}sl-sidebar{height:100% !important;}.active-border{display:none !important;}sl-rooster-week.week{width:calc(100% - 55px) !important;}sl-sidebar-page{padding-right:0 !important;}sl-header > div:first-of-type i{z-index:10000;--fg-on-primary-weak:' + menuColor + ';--action-neutral-strong:' + menuColor + ';}sl-header > div:first-of-type{--bg-neutral-weakest:' + highLightColor + '}</style>');
        }
        else if (get('layout') == 4) {
            tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">:root{--safe-area-inset-left:calc((100% - 1200px) / 2) !important;--safe-area-inset-right:calc((100% - 1200px) / 2) !important;}sl-home{position:relative;border:var(--thinnest-solid-neutral-normal);display:block;background:var(--bg-neutral-none) !important;' + (get('ui') == 0 ? '' : 'backdrop-filter:blur(' + get('uiblur') + 'px);') + '}sl-rooster-week.week{width:calc(100% - 55px) !important;}</style>');
        }
       ...
       function updateCheck() {
            ...
            if (get('version') == 4) {
                set('bools', get('bools').replaceAt(12, '1'));
                       ...
                       if (get('version') == 4.3) {
                set('transparency', (1 - get('transparency')));
    ...
    function updateCssVariables() {
        ...
        if (get('ui') != 0) {
            tn('head', 0).insertAdjacentHTML('beforeend', '<style id="mod-css-variables-2">sl-vakgemiddelden sl-dropdown,sl-cijfer-overzicht sl-dropdown{background:var(--bg-neutral-none);margin-top:-5px;margin-bottom:-5px;}' + (get('uiblur') == 0 ? '' : '.nieuw-bericht-form hmy-popup{top:70px !important;left:70px !important;}sl-plaatsingen,.nieuw-bericht-form,sl-header,sl-laatste-resultaat-item,sl-vakresultaat-item,.berichten-lijst,.vakken,' + (get('layout') == '4' ? '' : 'sl-vakresultaten,sl-geen-data,hmy-switch-group:has(hmy-switch),sl-bericht-detail .header,sl-bericht-nieuw > .titel,') + '.headers-container,.tabs,sl-studiewijzer-week:has(.datum.vandaag),#mod-top-menu,sl-home > * > sl-tab-bar.show,sl-dagen-header,sl-scrollable-title,sl-studiewijzer-weken-header,sl-cijfer-overzicht-voortgang,sl-rooster-tijden{backdrop-filter:blur(' + get('uiblur') + 'px);}') + '@media(max-width:767px){sl-laatste-resultaat-item{backdrop-filter:none;}sl-laatsteresultaten{backdrop-filter:blur(' + get('uiblur') + 'px);}}sl-rooster-dag[aria-hidden="true"],sl-rooster-week[aria-hidden="true"]{display:none;}:root, :root.dark.dark {--thinnest-solid-neutral-strong:1px solid transparent !important;--mod-semi-transparant:' + (darkmode ? 'rgba(0,0,0,0.35)' : 'rgba(255,255,255,0.65)') + ';--text-weakest:var(--text-weak);--border-neutral-normal:rgba(' + (darkmode ? '55,64,72,0' : '208,214,220,0') + ');' + ((darkmode && get('ui') > 0.9) ? '--text-weak:#fff;' : '') + '--bg-neutral-none:' + (darkmode ? 'rgba(0,0,0,' + (1 - (get('ui') / 100)) + ')' : 'rgba(255,255,255,' + (1 - (get('ui') / 100)) + ')') + ';--bg-neutral-weakest:' + (darkmode ? 'rgba(0, 0, 0, ' + (1 - (get('ui') / 100)) + ')' : 'rgba(255, 255, 255, ' + (1 - (get('ui') / 100)) + ')') + ';}.mod-multi-choice,input:not(:hover):not(:focus):not(.mod-color-textinput):not(.ng-pristine):not(.ng-dirty),textarea:not(:hover):not(:focus):not(.ng-pristine):not(.ng-dirty),.select-selected{border:1px solid rgba(0,0,0,0.1) !important;}hmy-toggle .toggle:not(:has(input:checked)) .slider{border:2px solid rgba(0,0,0,0.1) !important;}sl-rooster sl-dag-header-tab,.periode-icon{background:none !important;}@media (max-width:767px){' + (platform == 'Android' ? 'sl-rooster-item{margin-left:8px;}' : '') + 'sl-vakgemiddelden sl-dropdown,sl-cijfer-overzicht sl-dropdown{margin-top:10px;}}</style>');
        }
       ...
       const profilePictureSource = n(cn('foto', 0)) ? '' : cn('foto', 0).src;
    ...
    function profilePicture() {
       ...
       function userName() {
        if (!n(get('username')) && !n(get('realname')) && get('username') != get('realname')) {
          ...
          let logoClicks = 0;
    function modLogo() {
        if (!n(id('mod-logo-hat')) || !n(id('mod-logo-decoration'))) {
            return;
        }
        ...
        if (get('layout') == 2 || get('layout') == 3 || get('layout') == 5) {
            ...
            const logoHTML = '<div id="mod-logo-wrapper">' + (get('bools').charAt(8) == '0' ? getIcon('logo', null, menuColor, ' id="mod-logo"') : logo('mod-logo', '" data-clicks="' + (n(id('mod-logo')) ? '0' : id('mod-logo').dataset.clicks), 'var(--action-neutral-normal)')) + '</div>';
            ...
            if ((parseInt(get('birthday').charAt(0) + get('birthday').charAt(1)) == dayInt && parseInt(get('birthday').charAt(3) + get('birthday').charAt(4)) == (month + 1)) || (month + 1 == 12 && dayInt > 10) || (month + 1 == 12 && dayInt <= 5)) {
                id('mod-logo-hat').addEventListener('click', function () {
                    ...
                    else if (!this.classList.contains('mod-logo-hat-clicked')) {
        ...
        if (n(id('mod-logo-decoration')) && !tn('body', 0).classList.contains('mod-logo-decoration-hidden')) {
            ...
            if (!n(tn('sl-header', 0)) && ((month + 1 == M && (dayInt == D || dayInt == D + 1)) || (month + 1 == 10 && dayInt > 25) || (month + 1 == 5 && dayInt == 5) || (month + 1 == 12 && dayInt == 31) || (month + 1 == 1 && dayInt == 1))) {
                tn('sl-header', 0).style.overflow = 'hidden';
                id('mod-logo-decoration').addEventListener('click', function () { if (!this.classList.contains('mod-logo-decoration-clicked')) { this.classList.add('mod-logo-decoration-clicked'); setTimeout(function () { tn('body', 0).classList.add('mod-logo-decoration-hidden'); id('mod-logo-decoration').remove(); }, 900); } });
            }
        }
    }
       ...
       function setBackground() {
        ...
        if ((n(get('backgroundtype')) || get('backgroundtype') == 'image') && !n(get('background'))) {
            ...
            tn('head', 0).insertAdjacentHTML('beforeend', '<style id="mod-background-style">#mod-background{pointer-events:none;user-select:none;position:fixed;left:-' + get('blur') + ';width:calc(100% + 2 * ' + get('blur') + ');top:-' + get('blur') + ';height:calc(100% + 2 * ' + get('blur') + ');object-fit:cover;z-index:-1;}</style>');
        }
    ...
    (function () {
       ...
       function gradeGraphs(recapData) {
        if (isCollectingRecapData){
            ...
            var recapDates = [];
            let i = 2;
            while (i < recapData.length) {
                               if (Math.abs(i % 2) == 1) {
                    const grade = parseFloat(recapData[i]);
                    if (!isNaN(grade)) {
                        recapPoints.unshift(grade);
       ...
       function insertGradeDownloadButton() {
        ...
        else if ((!n(tn('sl-resultaat-item', 0)) || !n(tn('sl-vakgemiddelde-item', 0))) && n(tn('sl-vakresultaten', 0)) && get('bools').charAt(5) == "1") {
       ...
       function subjectGradesPage() {
        if (!n(tn('sl-vakresultaten', 0))) {
            ...
            const examPage = !n(tn('sl-examenresultaten', 0));
                       if (n(id('mod-grades-graphs')) && get('bools').charAt(7) == '1' && !n(tn('sl-resultaat-item', 1))) {
    ...
    function somtodayRecap() {
        ...
        let subjectsVisited = 0;
        let subjects;
        let closing = false;
        if (!n(id('somtoday-recap')) && n(id('somtoday-recap-wrapper')) && (!n(tn('sl-vakresultaten', 0)) || id('somtoday-recap').nextElementSibling.tagName == 'HMY-SWITCH-GROUP') || !n(tn('sl-cijfer-overzicht', 0))) {
            tryRemove(id('somtoday-recap'));
        }
        if (n(tn('sl-cijfer-overzicht', 0)) && ((!n(tn('sl-resultaat-item', 0)) || !n(tn('sl-vakgemiddelde-item', 0))) && n(tn('sl-vakresultaten', 0)) && n(id('somtoday-recap')))) {
            tn('hmy-switch-group', 0).insertAdjacentHTML('afterend', '<div id="somtoday-recap"><h3>Somtoday Recap</h3><p>Bekijk hier jouw jaaroverzicht van ' + year + '.</p><div id="somtoday-recap-arrows">' + getIcon('chevron-right', null, '#fff', 'id="recap-arrow-1"') + getIcon('chevron-right', null, '#fff', 'id="recap-arrow-2"') + getIcon('chevron-right', null, '#fff', 'id="recap-arrow-3"') + '</div></div>');
                ...
                id('recap-close').addEventListener('click', function () {
                    ...
                    async function collectRecapData() {
                        ...
                        for (let i = 0; true; i++) {
                            if (closing) { return; }
                                ...
                                break;
                                                       ...
                                                       else if (!n(tn('sl-vakgemiddelde-item', 0)) && n(cn('totaalgemiddelden', 0)) && i > 100 * 3) {
                        ...
                        const subjectLength = tn('sl-vakgemiddelde-item').length;
                        totalAverage = parseFloat(cn('totaalgemiddelden', 0).getElementsByClassName('cijfer')[0].innerHTML.substring(2).replace(',', '.'));
                            ...
                            if (closing) { return; }
                                                       ...
                                                       if (n(tn('sl-vakgemiddelde-item', i)) || n(tn('sl-vakgemiddelde-item', i).getElementsByTagName('sl-vakgemiddelde-item-cijfer')[0])) {
                                return;
                            }

                                                       tn('sl-vakgemiddelde-item', i).click();

                            let subjectHasData = true;
                            for (let j = 0; true; j++) {
                                if (closing) { return; }
                                                               if (!n(tn('sl-vakresultaten', 0)) && !n(cn('title', 0)) && !n(cn('cijfer', 0))) {
                                    break;
                                }
                                                               else if (!n(tn('sl-geen-data', 0))) {
                                    subjectHasData = false;
                                    break;
                                }
                                await new Promise(resolve => setTimeout(resolve, 10));
                            }
                            ...
                            if (subjectHasData) {
                                let subject = [];
                                if (!n(tn('sl-scrollable-title', 0)) && !n(tn('sl-scrollable-title', 0).getElementsByClassName('title')[0])) {
                                    subject.push(tn('sl-scrollable-title', 0).getElementsByClassName('title')[0].innerHTML);
                                    if (!n(tn('hmy-vak-icon', 0)) && !n(tn('hmy-vak-icon', 0).getElementsByTagName('i')[0])) {
                                        gradeicons[tn('sl-scrollable-title', 0).getElementsByClassName('title')[0].innerHTML] = tn('hmy-vak-icon', 0).getElementsByTagName('i')[0].innerHTML;
                                    }
                                }
                                else {
                                                                       subject.push('een vak');
                                }
                                ...
                                for (const element of tn('sl-resultaat-item')) {
                                    if (!n(element.getElementsByClassName('cijfer')[0]) && !n(element.getElementsByClassName('cijfer')[0].children[0])) {
                                        ...
                                        if (!isNaN(grade)) {
                                            ...
                                            if (dateObjects.length == 0) {
                                                tempGradeArray.push(grade);
                                                dateObjects.push(dateObject);
                                                tempWeightArray.push(weging);
                                            }
                                            else {
                                                                                               for (let i = 0; i < dateObjects.length; i++) {
                                                    if (dateObject <= dateObjects[i]) {
                                                        tempGradeArray.splice(i, 0, grade);
                                                        dateObjects.splice(i, 0, dateObject);
                                                        tempWeightArray.splice(i, 0, weging);
                                                        break;
                                                    }
                                                    else if (i >= dateObjects.length - 1) {
                                                        tempGradeArray.push(grade);
                                ...
                                for (let i = 0; i < tempGradeArray.length; i++) {
                                    subject.push(tempWeightArray[i]);
                                    subject.push(tempGradeArray[i]);
                                }

                                                               if (!isNaN(parseFloat(cn('cijfer', 0).innerHTML.replace(',', '.').replace(' ', '').replace(' ', '')))) {
                                    gradedata.push(subject);
                                }
                            }

                                                       cn('back-button', 0).click();

                            for (let j = 0; true; j++) {
                                if (closing) { return; }
                                                               if (!n(tn('sl-vakgemiddelde-item', 0))) {
                                    break;
                                }
                                await new Promise(resolve => setTimeout(resolve, 10));
                            }
        ...
        const availablePages = [subjectsLow, subjectsHigh, busyYear];

        function orderSubjects() {
            let usedSubjects = [];
            let subjectAverageList = [];
            let subjectAverageObject = {};
            let html = '';
            for (var i = 0; i < 5 && i < gradedata.length; i++) {
                let randomPick = Math.floor(Math.random() * gradedata.length);
                while (usedSubjects.includes(randomPick)) {
                    randomPick = Math.floor(Math.random() * gradedata.length);
                }
                usedSubjects.push(randomPick);
                subjectAverageList[i] = [gradedata[randomPick][0], gradedata[randomPick][1]];
                subjectAverageObject[gradedata[randomPick][0]] = gradedata[randomPick][1];
                html += '<div class="mod-item">' + gradeicons[gradedata[randomPick][0]] + '<p>' + gradedata[randomPick][0] + '</p>' + getIcon('grip-vertical', null, 'var(--text-weak)') + '</div>';
            }
            ...
            id('recap-nextpage').addEventListener('click', function () {
                ...
                function checkAnswers(first = false) {
                    ...
                    let subjectAverageListClone = subjectAverageList.slice();
                    const loopCount = subjectAverageListClone.length;
                    for (var i = 0; i < loopCount; i++) {
                        let maxGrade = 0;
                        let maxGradeIndex;
                        for (var j = 0; j < subjectAverageListClone.length; j++) {
                            if (subjectAverageListClone[j][1] > maxGrade) {
                                maxGrade = subjectAverageListClone[j][1];
                                maxGradeIndex = j;
                            }
                        }
                                               const pElement = id('mod-grade-average-sort-list').getElementsByClassName('mod-item')[i].getElementsByTagName('p')[0];
                        if (pElement.innerHTML == subjectAverageListClone[maxGradeIndex][0]) {
                            pElement.classList.remove('wrong');
                            pElement.classList.add('right');
                            if (first) {
                                pElement.insertAdjacentHTML('afterend', '<p>' + subjectAverageObject[pElement.innerHTML] + '</p>');
                            }
                        }
                                               else {
                        ...
                        subjectAverageListClone.splice(maxGradeIndex, 1);
                    }
                }
                checkAnswers(true);
        ...
        function closeRecapPage() {
            ...
            pages++;
            availablePages[Math.round(Math.random() * (availablePages.length - 1))]();
            let i;
            switch (pages) {
                case 1:
        ...
        function award() {
            ...
            while (award == 'none' && times < 50) {
                ...
                const randomAwardTry = Math.round(Math.random() * (12 - 1) + 1);
                switch (randomAwardTry) {
                    ...
                    case 3:
                                               subject = -1;
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('wis') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                        if (subject != -1 && gradedata[subject][1] > 5.5) {
                            award = 'algebra';
                    ...
                    case 4:
                        ...
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('sch') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                    ...
                    case 5:
                        ...
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('fra') != -1 || gradedata[i][0].toLowerCase().indexOf('eng') != -1 || gradedata[i][0].toLowerCase().indexOf('dui') != -1 || gradedata[i][0].toLowerCase().indexOf('spa') != -1 || gradedata[i][0].toLowerCase().indexOf('chi') != -1 || gradedata[i][0].toLowerCase().indexOf('taal') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                    ...
                    case 6:
                        ...
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('gri') != -1 || gradedata[i][0].toLowerCase().indexOf('grk') != -1 || gradedata[i][0].toLowerCase().indexOf('lat') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                    ...
                    case 7:
                        ...
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('nat') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                    ...
                    case 9:
                        ...
                        i = 2;
                        for (const subject of gradedata) {
                            if (!isNaN(parseFloat(subject[0])) && parseFloat(subject[0]) >= 8.5) {
                                max = true;
                            }
                        }
                        if (max) {
                    ...
                    case 11:
                        ...
                        i = 0;
                        while (i < gradedata.length) {
                            if (gradedata[i][0].toLowerCase().indexOf('beeldend') != -1 || gradedata[i][0].toLowerCase().indexOf('kunst') != -1 || gradedata[i][0].toLowerCase().indexOf('art') != -1 || gradedata[i][0].toLowerCase().indexOf('vorming') != -1 || gradedata[i][0].toLowerCase().indexOf('ckv') != -1) {
                                subject = i;
                            }
                            i++;
                        }
                        if (subject != -1 && gradedata[subject][1] > 5.5) {
                            award = 'artiest';
                            description = 'je een voldoende staat voor beeldende vorming';
                            icon = 'palette';
                        }
                        break;
                    case 12:
        ...
        function subjectsHigh() {
            ...
            let highestName = '--';
            let secondHighest = 0;
            let secondHighestName = '--';
            for (const subject of gradedata) {
                let i = 0;
                while (i < subject.length) {
                    if (i > 1) {
                                               if (Math.abs(i % 2) == 1) {
                            const grade = parseFloat(subject[i]);
                            if (!isNaN(grade) && grade > highest) {
                                secondHighest = highest;
                                secondHighestName = highestName;
                                highest = subject[i];
                                highestName = subject[0];
                            }
                        }
                    }
                    i++;
            ...
            cn('recap-page', 0).innerHTML = '<h1>' + (pages > 1 ? 'En w' : 'W') + 'at heb je toch goede cijfers gehaald</h1><h2>Toen je een <i>' + highest + '</i> haalde voor ' + highestName + ' was je echt de uitblinker van de klas.</h2><h3>En vergeet ook niet de <i>' + secondHighest + '</i> die je voor ' + secondHighestName + ' haalde!</h3><a id="recap-nextpage">Volgende</a>';
            id('recap-nextpage').addEventListener('click', closeRecapPage);
        }
        function subjectsLow() {
            ...
            for (const subject of gradedata) {
                ...
                while (i < subject.length) {
                    if (i > 1) {
                                               if (Math.abs(i % 2) == 1) {
                            const grade = parseFloat(subject[i]);
                            if (!isNaN(grade) && grade < lowest) {
                                lowest = grade;
                                lowestName = subject[0];
            ...
            cn('recap-page', 0).innerHTML = '<h1>Soms was een toets vervelend</h1><h2>Sommige toetsen zijn veel te moeilijk. Zoals de toets waarbij je een <i>' + lowest + '</i> haalde voor ' + lowestName + '.</h2><h3>Gelukkig bleef je doorzetten en nu is je gemiddelde een <i>' + lowestSubject[1] + '</i>!</h3><a id="recap-nextpage">Volgende</a>';
            id('recap-nextpage').addEventListener('click', closeRecapPage);
        }
        function twoTrueOneFalse() {
                       let i = 0;
                       let averageSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
            let average = parseFloat(averageSubject[1]);
            while (isNaN(average)) {
                if (i > 100) {
                    average = 5.4;
                    break;
                }
                averageSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
                average = parseFloat(averageSubject[1]);
                i++;
            }
                       let gradeSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
            let grade = parseFloat(gradeSubject[2 * Math.round(Math.max(Math.round(Math.random() * (gradeSubject.length - 1)), 4) / 2) - 1]);
            i = 0;
            while (isNaN(grade)) {
                if (i > 100) {
                    gradeSubject = gradedata[0];
                    grade = gradeSubject[3];
                    break;
                }
                gradeSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
                grade = parseFloat(gradeSubject[2 * Math.round(Math.max(Math.round(Math.random() * (gradeSubject.length - 1)), 4) / 2) - 1]);
                i++;
            }
                       let amountSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
            let amount = (amountSubject.length - 2) / 2;
            let real;
            const random = Math.round(Math.random() * (3 - 1) + 1);
            switch (random) {
                case 1:
                    averageSubject = gradedata[Math.round(Math.random() * (gradedata.length - 1))];
                    real = averageSubject[1];
                    if (averageSubject[1] == average) {
                        average += Math.round(Math.random() * (2 - 0.5) + 0.5 * 100) / 100;
                ...
                case 2:
                    real = grade;
                    i = 0;
                    while (gradeSubject.includes(grade) || real == grade) {
                        if (i > 100) {
                            if (isNaN(grade)) {
                                grade = 0.5;
                            }
            ...
            cn('recap-page', 0).innerHTML = '<h1>Kies een van de opties.</h1><h2>Welke van de volgende opties klopt niet?</h2><label><input type="checkbox" id="recap-option-1"/><p>Je staat een <span class="number">' + average + '</span><span class="correction"></span> voor ' + averageSubject[0] + '</p></label><label><input type="checkbox" id="recap-option-2"/><p>Je hebt een <span class="number">' + grade + '</span><span class="correction"></span> voor ' + gradeSubject[0] + ' gehaald</p></label><label><input type="checkbox" id="recap-option-3"/><p>Je hebt <span class="number">' + amount + '</span><span class="correction"></span> ' + (amount == 1 ? 'cijfer' : 'cijfers') + ' voor ' + amountSubject[0] + ' gehaald</p></label><a id="recap-nextpage">Controleren</a>';
            let clicked = false;
            id('recap-nextpage').addEventListener('click', function () {
                if (clicked) {
                    closeRecapPage();
        ...
        function guessTheGraph() {
            ...
            const chosenSubject = Math.round(Math.random() * (gradedata.length - 1));
            gradeGraphs(gradedata[chosenSubject]);
            const random = Math.round(Math.random() * (3 - 1) + 1);
            id('recap-option-' + random).innerHTML = gradedata[chosenSubject][0];
            let fakeOptionOne = gradedata[Math.round(Math.random() * (gradedata.length - 1))][0];
            let i = 0;
            const subjectArray = ['Aardrijkskunde', 'Geschiedenis', 'Nederlands', 'Engels', 'Frans', 'Natuurkunde', 'Wiskunde', 'Biologie', 'Scheikunde'];
            while (fakeOptionOne == gradedata[chosenSubject][0]) {
                if (i > 100) {
                    fakeOptionOne = subjectArray[Math.floor(Math.random() * subjectArray.length)];
                    break;
                }
                fakeOptionOne = gradedata[Math.round(Math.random() * (gradedata.length - 1))][0];
                i++;
            }
            i = 0;
            let fakeOptionTwo = gradedata[Math.round(Math.random() * (gradedata.length - 1))][0];
            while (fakeOptionTwo == gradedata[chosenSubject][0] || fakeOptionTwo == fakeOptionOne) {
                if (i > 100) {
                    fakeOptionOne = subjectArray[Math.floor(Math.random() * subjectArray.length)];
                    break;
                }
                fakeOptionTwo = gradedata[Math.round(Math.random() * (gradedata.length - 1))][0];
                i++;
            }
            id('recap-text-' + random).innerHTML = gradedata[chosenSubject][0];
            switch (random) {
                case 1:
       ...
       function openSettings() {
        tryRemove(id('mod-setting-panel'));
            ...
            '<div class="br"></div><p>' + (n(somtodayversion) ? 'Onbekende versie' : 'Versie ' + somtodayversion) + ' van Somtoday | Versie ' + version + ' van Somtoday Mod</p><p style="user-select:none;">Bedankt voor het gebruiken van <span id="somtoday-mod-version-easter-egg">Somtoday Mod ' + platform + '</span>!</p>' + updateinfo + '<div class="br"></div></div>');
       ...
       function saveReload() {
        if (filesProcessed >= (cn('mod-file-input').length + 1)) {
       ...
       function checkNewUser() {
        if (n(get('firstused'))) {
            ...
            set('lastjubileum', 0);
            execute([reset]);
            tn('head', 0).insertAdjacentHTML('afterbegin', '<style>#welcome{position:fixed;top:0;left:0;width:100%;height:100%;z-index:10000000;background:white;transition:opacity 0.3s ease;}#welcome *{box-sizing:border-box;color:#000;}#welcome h2{line-height:36px;font-size:36px;color:#09f;margin-bottom:30px;}#welcome h3{font-size:24px;margin-top:15px;}#welcome #errordata{width:25px;height:25px;margin:0;margin-top:20px;display:inline-block;}#welcome a{margin-top:20px;display:block;border:3px solid #09f;padding:15px 25px;border-radius:16px;font-size:20px;transition:0.3s background ease,0.2s color ease;width:fit-content;-webkit-user-select:none;user-select:none;cursor:pointer;}#welcome a:hover{background:#09f;color:white;}#welcome label{width:calc(100% - 50px);-webkit-user-select:none;user-select:none;cursor:pointer;font-size:20px;vertical-align:top;padding:19px 16px;display:inline-block;}#welcome .modlogo{transition:transform 0.3s ease;}#welcome .modlogo:hover{transform:scale(1.05);}#welcome-background{background:#09f;float:right;width:750px;max-width:50%;height:100%;position:relative;padding-right:75px;transition:width .2s ease,padding-right .2s ease;}#welcome-background center{position:relative;top:50%;transform:translateY(-50%);}#wave{position:absolute;left:0;width:100%;top:0;height:100%;transform:translateX(-240px);}#welcome-text{float:left;width:calc(100% - 850px);padding-right:150px;padding:25px 50px;position:absolute;top:50%;transform:translateY(-50%);}#welcome.android #mod-android-logo{padding:15px;display:block;margin:20px auto;border:2px solid #eee;border-radius:8px;width:85px;height;height:85px;}@media (max-width:1500px){#welcome-background{width:550px;}#welcome-text{width:calc(100% - 650px);}}@media (max-width:1300px){#welcome-background{width:350px;}#welcome-text{width:calc(100% - 450px);}}@media (max-width:1060px){#welcome-background{width:250px;padding-right:0;}.modlogo{width:100px;height:100px;}#wave{display:none;}#welcome-text{width:calc(100% - 250px);}}@media (max-width:700px){#welcome-background{width:100%;max-width:100%;position:absolute;height:200px;}#welcome-text{width:100%;}}@media (max-height:850px), (max-width:370px){#welcome-text{top:200px;transform:none;}}@media (max-width:370px){#welcome-text{padding:25px;}}@media (max-height:650px) and (max-width:700px){#welcome-background{display:none;}}@media (max-height:650px){#welcome-text{top:0;}#welcome.android #mod-android-logo{height:50px;width:50px;margin:10px auto;padding:10px;}}@media (max-height:550px){#welcome.android #mod-android-logo{visibility:hidden;height:0;margin:5px auto;}}@media (max-height:520px){#welcome h2{margin-bottom:15px;line-height:1;font-size:30px;}#welcome a{margin-top:0;}#welcome h3{font-size:18px;margin-top:10px;line-height:1;}}#welcome.android label{font-size:16px;}#welcome.android a{font-size:16px;padding:10px 20px;}#welcome.android #mod-android-text{width:100%;padding:0 20px;margin:auto;max-width:450px;}#welcome.android{overflow:auto;}</style>');
            if (platform == 'Android') {
                id('somtoday-mod').insertAdjacentHTML('afterbegin', '<div id="welcome" class="android">' + logo('mod-android-logo', null, '#09f') + '<div id="mod-android-text"><h3>Welkom!</h3><p>Je hebt net de Somtoday Mod Android APK geïnstalleerd. Met deze app kun je alles wat je ook in de normale Somtoday app kan, plus nog veel meer doordat Somtoday Mod erbij zit.</p><p>Voordat je doorgaat, deze app is niet geaffilieerd met Somtoday. Gebruik is op eigen risico. Zorg ervoor dat je regelmatig op updates checkt om de app up to date te houden.</p><input id="errordata" type="checkbox"><label for="errordata">Verzamel error-data om Somtoday Mod te verbeteren</label><a id="continuetosom">Door naar Somtoday</a></div></div>');
            }
            else {
                id('somtoday-mod').insertAdjacentHTML('afterbegin', '<div id="welcome"><div id="welcome-text"><h2>Somtoday Mod is ge&iuml;nstalleerd!</h2><h3>Bedankt voor het downloaden van Somtoday Mod!</h3><h3>De mod zal Somtoday voor je aanpassen, zodat het er mooier uitziet.</h3><input id="errordata" type="checkbox"/><label for="errordata">Verzamel error-data om Somtoday Mod te verbeteren</label><div class="br"></div><a id="continuetosom">Door naar Somtoday</a></div><div id="welcome-background"><svg id="wave" width="245.3" height="1440"><path d="m235 937-6-48c-5-48-15-144-42-240s-69-192-70-288c1-96 43-192 91-288s102-192 101-288c1-96-53-192-80-240l-26-48h160V937z" transform="translate(-117 503)" fill="#09f"/></svg><center>' + logo(null, 'modlogo', '#fff') + '</center></div></div>');
    ...
    function addSlider(name, property, min, max, unit, defaultValue) {
       ...
       async function openModSettingsDirectly() {
        if (window.location.hash == '#mod-settings' || get('opensettingsIntention') == '1') {
