...
const version_name = '5.4-release';
const contributors = {"Jona-Zwetsloot":"https:\/\/avatars.githubusercontent.com\/u\/170928581?s=64&v=4","levkris":"https:\/\/avatars.githubusercontent.com\/u\/105733478?s=64&v=4","compiledkernel-idk":"https:\/\/avatars.githubusercontent.com\/u\/220610112?s=64&v=4","timmah12341":"https:\/\/avatars.githubusercontent.com\/u\/200096760?s=64&v=4","Minionguyjpro":"https:\/\/avatars.githubusercontent.com\/u\/66115754?s=64&v=4","JxxIT":"https:\/\/avatars.githubusercontent.com\/u\/110342008?s=64&v=4"};
        ...
        tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">@media (min-width:767px){:root{--min-content-vh:calc(100vh - ' + (get('layout') == '4' ? '66px' : '74px') + ') !important;}}</style>');
            ...
            tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style">sl-header .item span{display:none !important;}@media (max-width:1279px){sl-tab-bar:first-of-type .item span{display:none !important;}' + ((get('layout') == 2 || get('layout') == 3 || get('layout') == 5) ? 'sl-tab-bar:first-of-type sl-tab-item i{padding-top:0!important}}sl-header .item i{padding-top:36px !important;}' : '}') + '</style>');
               ...
               if (!n(get('customcss')) && get('customcss').trim() !== '') {
                ...
                .replace(/javascript:[^'"]+/gi, '')                 .replace(/@import[^;\n]+/gi, '');             tn('head', 0).insertAdjacentHTML('beforeend', '<style class="mod-style mod-custom-css">' + sanitizedCSS + '</style>');
        }
    }
            ...
            if (id('customcss')) {
                    ...
                    const content = e.target.value;
                        ...
                        e.target.value = e.target.value.replace(/javascript:[^'"]*/gi, '').replace(/@import[^;\n]*/gi, '');
                                  ...
                                  themeCount = 0;            addTheme('Standaard', '', '#0067c2', '#e69b22');
    ...
    <div id="category-background">
        ...
        <div id="mod-bg-image" style="display:{{display_bg_image}}" class="mod-background-type-content">
            ...
            <div id="mod-filters" style="{{display_mod_filters}}">
                ...
                <div class="br"></div>
                {{addSlider_brightness}}{{addSlider_contrast}}{{addSlider_saturate}}{{addSlider_opacity}}{{addSlider_huerotate}}{{addSlider_grayscale}}{{addSlider_sepia}}{{addSlider_invert}}{{addSlider_blur}}
        ...
        <div id="mod-bg-slideshow" style="display:{{display_bg_slideshow}}" class="mod-background-type-content">
            ...
            <div id="mod-background-wrapper">{{slideshow}}<label tabindex="0" for="addbackground"><svg height="1em" viewBox="0 0 512 512">
