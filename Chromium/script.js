...
chrome.storage.local.get(["enabled"]).then((result) => {
  if (result.enabled) {
    // GET DATA
    chrome.storage.local.get(["background", "birthday", "blur", "bools", "firstused", "fontname", "icon", "initials", "lastjubileum", "lastused", "layout", "nicknames", "primarycolor", "profilepic", "reload", "theme", "title", "transparency", "version", "zoom"]).then((result) => {
      data = {
        name: "SOMTODAY MOD DATA",
